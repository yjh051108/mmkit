...
fig.tight_layout()
fig.savefig('figures/fig_heatmap.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
ax.set_aspect('equal')
fig.tight_layout()
fig.savefig('figures/fig_donut.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
ax1.grid(axis='y', alpha=0.12, linestyle='--', color=COLORS['grid'])
fig.tight_layout()
fig.savefig('figures/fig_dual_axis.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
ax.grid(axis='y', alpha=0.12, linestyle='--', color=COLORS['grid'])
fig.tight_layout()
fig.savefig('figures/fig_violin.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
fig.savefig('figures/fig_subplots.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
