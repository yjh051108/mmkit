...
fig.tight_layout()
fig.savefig('figures/fig_tsne.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
ax.grid(axis='y', alpha=0.15, linestyle='--')
fig.tight_layout()
fig.savefig('figures/fig_raincloud.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_loss_landscape.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
fig.savefig('figures/fig_qualitative.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_radar.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_3d_features.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
