...
fig.tight_layout()
fig.savefig('figures/fig_radar.pdf', dpi=300, bbox_inches='tight'); plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_3d_surface.pdf', dpi=300, bbox_inches='tight'); plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_confusion_matrix.pdf', dpi=300, bbox_inches='tight'); plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_spatiotemporal.pdf', dpi=300, bbox_inches='tight'); plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_pareto_3d.pdf', dpi=300, bbox_inches='tight'); plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('figures/fig_3d_cluster.pdf', dpi=300, bbox_inches='tight')
plt.close(fig)
```
