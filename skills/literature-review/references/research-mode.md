...
> - `/literature-review "topic" — sources: zotero` — only search Zotero
> - `/literature-review "topic" — sources: web` — only search the web (skip all local)
> - `/literature-review "topic" — arxiv download: true` — download top relevant arXiv PDFs
> - `/literature-review "topic" — arxiv download: true, max download: 10` — download up to 10 PDFs
...
/literature-review "diffusion models" — sources: all         → all
...
/literature-review "topic" — sources: obsidian, local, web   → skip Zotero
```
...
# If not found, check the kit install (e.g. ~/.claude/skills/arxiv/)
