---
name: comp-paper-en
description: "Mathematical modeling competition paper writing in English (MCM/ICM/APMCM) — LaTeX (PDF mode) or Markdown (docx mode). Generate complete paper following COMAP format. Use when user says \"write MCM paper\", \"美赛论文\", \"English competition paper\"."
...
- **docx mode**: `paper/main.md` (single file, ≥ 5KB). Do NOT create `paper/main.tex`. Read `references/docx-conventions.md` in this skill for the Markdown conventions.
...
# TikZ generated by paper-figure as figures/tikz_diagrams.tex → compiled to figures/tikz_diagrams.pdf
...
DrawIO figures (roadmap, flow charts, pipeline diagrams) are appended at the **end** of `latex_includes.tex` by the paper-figure step. You MUST embed them:
